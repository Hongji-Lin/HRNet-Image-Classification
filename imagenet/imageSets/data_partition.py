...
def move_img(full_fileDir, empty_fileDir, full_valDir, empty_valDir):
    ...
    for full_name in full_sample:
        shutil.move(full_fileDir + full_name, full_valDir + full_name)
    for empty_name in empty_sample:
        shutil.move(full_fileDir + empty_name, empty_valDir + empty_name)
    return
...
if __name__ == '__main__':
    full_fileDir = '../train/full/'  # full源图片文件夹路径
    empty_fileDir = '../train/empty/'  # empty源图片文件夹路径
